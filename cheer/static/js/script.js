var LANGUAGES = {
    ...
    "en": {
        ...
        texts: {
            "page-title": "Takagi  help you cheer!",
            "doc-title": "Takagi  help you cheer!",
            "page-descriptions": "A website for ,it's nice!",
            "counter-descriptions": ["Takagi has already told", "Takagi has already told Nishikata"],
            "counter-unit": "times",
            "counter-button": ["come on~!", "like you~!"],
        ...
        texts: {
            "page-title": "高木同学为你加油",
            "doc-title": "高木同学为你加油~",
            "page-descriptions": "给高木同学写的网站，高木同学yyds！点击下方按钮，高木同学为你加油。",
            "counter-descriptions": ["高木同学已经喊~了", "高木同学已经对西片说了"],
            "counter-unit": ["次", "次加油"],
            "counter-button": ["加油", "喜欢你~"],
        ...
        texts: {
            "page-title": "* 高木同學為你加油 ✩‧₊˚",
            "doc-title": "高木同學為你加油～",
            "page-descriptions": "給高木同學寫的網站，高木同學yyds！",
            "counter-descriptions": ["高木同學已經喊了", "高木同學已經對西片說了"],
            "counter-unit": ["次", "次加油"],
            "counter-button": ["* 加油 ✩‧₊˚", "* 喜欢你 ✩‧₊˚"],
        ...
        texts: {
            "page-title": "高木さん応援します!~",
            "doc-title": "高木さん応援します!~",
            "page-descriptions": "高木さんに書いたサイトで,高木さんが大好きなんです。",
            "counter-descriptions": "高木さんが呼びました",
            "counter-unit": "回",
            "counter-button": "がんばって ~!",
...
(() => {
    ...
    // try caching the 唱歌.gif and hertaa2.gif images by calling the tryCacheUrl function
    cacheStaticObj("img/takagi1.png");
    ...
    function animateHerta() {
        ...
        elem.src = cacheStaticObj(`img/takagi1.png`);
